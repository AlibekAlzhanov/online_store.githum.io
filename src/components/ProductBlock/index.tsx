...
const typeNames = ['қолма қол', 'банк арқылы']
const sizeNames = ['жеткізумен', 'жеткізусіз']
    ...
    <div className="block-wrapper">
      <div className="block">
        <Link key={id} to={`/Product/${id}`}>
          <img className="block__image" src={imageUrl} alt="Product" />
        ...
        <div className="block__bottom">
          <div className="block__price"> {price} тг</div>
          <button
            onClick={onClickAdd}
